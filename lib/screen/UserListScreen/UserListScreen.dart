...
import '../../model/UsersList/SearchbystaffcodeResponse.dart' as hello;
...
class _UserListScreenState extends State<UserListScreen> {
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [MyColors.lightBlue, MyColors.blueColorCode],
                        ),
                        borderRadius: BorderRadius.circular(14),
                        boxShadow: [
                          BoxShadow(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: _infoTile(
                                            "Mobile",
                                             (user.mobileNo == null || user.mobileNo.toString().trim().isEmpty)
                                                ? "NA"
  ...
  Widget _staffinfoTile(String title, String value) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
