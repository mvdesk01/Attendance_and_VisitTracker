...
import 'package:attendance_system_ios/screen/admin_side/user_list_screen/user_list_screen.dart';
...
//-----------------------
                ...
                GestureDetector(
                  ...
                  child: Padding(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          leading: Text(PlantCode ?? PlantCode.toString(),
                              style: TextStyle(
                                fontSize: 15.0,
                              )),
                          trailing: isPlantCodecontainerselected
                              ? IconButton(
                            icon: Icon(
  ...
  _validation() {
    if (_StaffCodeController.text.isEmpty) {
      ...
      String dobText =
          _DOBController.text; // Should now be in yyyy-MM-dd format
  ...
  _addStaffEntry() {
    DateTime dateOfBirth = DateTime(selectedDate.year, selectedDate.month,
        selectedDate.day); // Example DateTime
    String formattedDate = DateFormat('yyyy-MM-dd').format(dateOfBirth);
    DateTime joiningDate = DateTime(
        selectedDateofjoining.year,
        selectedDateofjoining.month,
        selectedDateofjoining.day); // Example DateTime
  ...
  Future<void> _selectDateOfJoining(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        ...
        _DOJController.text = formatter.format(selectedDateofjoining);
        date = formatter.format(selectedDateofjoining);
      });
    }
  }
