...
// import 'package:attendance_system_ios/screen/user_list_screen/add_new_staff.dart';
...
import '../user_profile_admin/user_profile_admin.dart';
import '../attendance_report_admin/attendance_report_admin.dart';
import '../expense_details_admin/expense_details_admin.dart';
import '../visit_tracking_admin/visit_track_admin.dart';
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                print("visit_track_report Clicked:");
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => BlocProvider(
...
class _UserListScreenState extends State<user_list_screen> {
  late MainBloc mainBloc;
  final storage = FlutterSecureStorage();
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                print("visit_management Report Clicked:");
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => BlocProvider(
