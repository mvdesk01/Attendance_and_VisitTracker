      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // buildTextField('visit_management Location', visitlocationController.text, readOnly: true),
            // buildTextField('visit_management Purpose', visitpurposeController.text, readOnly: true),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                buildTextField('visit_management Purpose', expDetails?.visitPurpose ?? "", readOnly: true),
