...
//               setState(() {
//                 CoffList = List.from(
//                     state.fetchCoffTransactionsResponse.message ?? []);
//               });
//
...
//                 // ✅ Clear the list first to force UI refresh
//                 setState(() {
//                   CoffList.clear();
//                 });
//
...
//                                   child: Text("STATUS: PENDING",style: TextStyle(color: MyColors.greenColorCode),),
//                                 )
//                             ),
//
//                             GestureDetector(
...
//                                                               staffCode: staffCode!,
//                                                               transactionId: CoffList[index].otwofFid.toString(),
//                                                               token: Auth_Token!,
//                                                             ),
//                                                           );
//                                                         },
          ...
          bool? result = await Navigator.of(context).push(
            MaterialPageRoute(
              builder: (_) => BlocProvider(
                ...
                child: AddCoffScreen(
                    flag: 1,
                    datum: CoffList.isEmpty ? Message() : CoffList[0]),
              ),
            ),
          );
