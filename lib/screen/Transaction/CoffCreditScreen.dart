...
class _CoffcreditscreenState extends State<Coffcreditscreen> {
  ...
  Future<void> getData() async {
    ...
    mainBloc.add(FetchCoffTransactionsEvents(satffCode: staffCode!, token: Auth_Token!));
            ...
            new MaterialPageRoute(
                builder: (_) =>
                    BlocProvider(
                        ...
                        child: AddCoffScreen(flag: 1 ,datum:  CoffList!.length == 0 ? Message() : CoffList![0])
                    )
            ),
          );
        ...
        child: BlocListener<MainBloc, MainState>(
          listener: (context, state) {
            ...
            else if (state is FetchCoffTransactionsLoadedState)
            {
              ...
              CoffList.addAll(state.fetchCoffTransactionsResponse.message ?? []);


              print("Pending CoffList  Size: "+CoffList!.length.toString());


              print("FetchCoffTransactionsErrorState otDate...."+state.fetchCoffTransactionsResponse.message!.first.otDate!.toString());
            ...
            else if (state is CancelCoffOTHWOFFLoadedState)
            {
              ...
              if(state.cancelGatepassResponse.message =="COff Canceled Successfully..")
              {
                                  ...
                                  new MaterialPageRoute(
                                      builder: (_) =>
                                          BlocProvider(
                                              ...
                                              child: AddCoffScreen(flag: 2,datum:  CoffList[index])
                                          )
                                  ),
                                );                            },
                              child: Container(
                                                    ...
                                                    Padding(
                                                      ...
                                                      MaterialButton(
                                                        ...
                                                        onPressed:
                                                          ...
                                                          mainBloc.add(CancelCoffOTHWOFFEvents(staffCode: staffCode!,transactionId: CoffList[index].otwofFid.toString(), token: Auth_Token!));
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(CoffList[index].staff.toString()!=null ? CoffList[index].staff.toString() : "0",style: TextStyle(color: MyColors.text5ColorCode,fontSize: 18),),
                                  ],
                                ),
                              ),
                              Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(CoffList[index].otDate!=null ? CoffList[index].otDate! :  "",textAlign:TextAlign.left,style: TextStyle(color: MyColors.text5ColorCode,fontSize: 18),),
                                    ],
                                  )
                              )
                        ...
                        Row(
                          ...
                          children: [  Expanded(
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Coff Type",style: TextStyle(color: MyColors.textprofiledetailColorCode,fontSize: 18),),
                                  Text(CoffList[index].type!=null ? CoffList[index].type! : "",textAlign:TextAlign.left,style: TextStyle(color: MyColors.text5ColorCode,fontSize: 18),),
                                ],
                              )
                          ),
                            Expanded(
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Total Hours",style: TextStyle(color: MyColors.textprofiledetailColorCode,fontSize: 18),),
                                  Text(CoffList[index].ttlHrs!=null ? CoffList[index].ttlHrs! : "",style: TextStyle(color: MyColors.text5ColorCode,fontSize: 18),),
                                ],
                              ),
                            ),
