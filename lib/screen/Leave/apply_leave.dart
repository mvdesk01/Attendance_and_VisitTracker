...
//             ),
//             title: Text(
//               widget.flag == 2 ? 'Update Leave' : 'New Leave Request',
...
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: [
//                 // STEP 1: LEAVE CONFIGURATION
//                 _buildSectionHeader(
//                     Icons.settings_suggest_outlined, "Configuration"),
//                 _buildFormCard([
//                   _buildDropdown(stdText, labelText),
//                   const SizedBox(height: 16),
//                   _buildModernField(
//                     controller: leaveBalanceController,
//                     label: 'Leave Balance Available',
...
//
//                 // STEP 2: DATES & TIMING
//                 _buildSectionHeader(Icons.calendar_month_outlined, "Schedule"),
//                 _buildFormCard([
//                   _buildDateRow(
//                       "From Date", fromDateController, Fromtimefirsthalf,
//                       (val) {
//                     setState(() {
//                       Fromtimefirsthalf = val!;
//                       Fromtimesecondhalf = !val;
//                     });
//                     _calculateDays();
//                   }, leaveInFraction, stdText),
//                   const Padding(
//                     padding: EdgeInsets.symmetric(vertical: 16),
//                     child: Divider(thickness: 1, height: 1),
//                   ),
//                   _buildDateRow("To Date", toDateController, Totimefirsthalf,
//                       (val) {
//                     setState(() {
//                       Totimefirsthalf = val!;
//                       Totimesecondhalf = !val;
//                     });
//                     _calculateDays();
//                   }, leaveInFraction, stdText),
//                   const SizedBox(height: 8),
//                   _buildFractionToggle(stdText),
//                   if (leaveInFraction) ...[
//                     const SizedBox(height: 16),
//                     Row(
//                       children: [
...
//                                 "Start",
//                                 fromTimeController,
//                                 () => _pickTime(fromTime, fromTimeController),
//                                 stdText)),
...
//                                 "End",
//                                 toTimeController,
//                                 () => _pickTime(toTime, toTimeController),
//                                 stdText)),
//                       ],
//                     ),
//                   ],
...
//                 _buildSectionHeader(
//                     Icons.note_alt_outlined, "Additional Details"),
//                 _buildFormCard([
//                   _buildInput(addressController, 'Current Address',
//                       Icons.map_outlined, stdText),
//                   const SizedBox(height: 16),
//                   _buildInput(reasonController, 'Reason for leave',
//                       Icons.chat_bubble_outline_rounded, stdText),
//                   const SizedBox(height: 16),
//                   _buildInput(mobileController, 'Emergency Contact',
//                       Icons.phone_enabled_outlined, stdText,
//                       isPhone: true),
//                 ]),
//
...
//       child: Row(
//         children: [
//           Icon(icon, size: 18, color: MyColors.lightBlue),
...
//   }
//
//   Widget _buildDropdown(double stdText, double labelText) {
//     return DropdownButtonFormField<String>(
//       value: selectedLeaveType,
//       style: GoogleFonts.inter(fontSize: stdText, color: Colors.black87),
//       decoration: InputDecoration(
//         labelText: 'Select Leave Type',
//         labelStyle: TextStyle(fontSize: labelText, color: Colors.grey[600]),
//         filled: true,
//         fillColor: Colors.grey[50],
//         prefixIcon:
//             Icon(Icons.category_outlined, size: 20, color: MyColors.lightBlue),
//         border: OutlineInputBorder(
...
//         setState(() {
//           selectedLeaveType = value!;
//           leaveBalanceController.text = selectedLeaveType == 'LWP'
//               ? '0'
//               : leaveBalances[selectedLeaveType]?.toString() ?? '0';
//         });
//       },
...
//         labelText: label,
//         prefixIcon:
//             Icon(icon, size: 20, color: highlight ? Colors.green : Colors.grey),
//         filled: true,
//         fillColor: highlight ? Colors.green.withOpacity(0.05) : Colors.grey[50],
//         border: OutlineInputBorder(
//             borderRadius: BorderRadius.circular(12),
//             borderSide: BorderSide.none),
//       ),
...
//   }
//
//   Widget _buildDateRow(String label, TextEditingController ctrl, bool groupVal,
//       Function(bool?) onChanged, bool disabled, double fontSize) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         TextField(
...
//         Row(
//           children: [
//             _buildChipRadio("1st Half", true, groupVal, onChanged, disabled),
//             const SizedBox(width: 8),
//             _buildChipRadio("2nd Half", false, groupVal, onChanged, disabled),
//           ],
//         ),
//       ],
//     );
//   }
//
//   Widget _buildChipRadio(String text, bool val, bool groupVal,
//       Function(bool?) onChg, bool disabled) {
//     bool isSelected = val == groupVal;
//     return GestureDetector(
//       onTap: disabled ? null : () => onChg(val),
//       child: AnimatedContainer(
//         duration: const Duration(milliseconds: 200),
//         padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
//         decoration: BoxDecoration(
//           color: isSelected ? MyColors.lightBlue : Colors.transparent,
//           borderRadius: BorderRadius.circular(20),
//           border: Border.all(
//               color: isSelected ? MyColors.lightBlue : Colors.grey[300]!),
//         ),
//         child: Text(
//           text,
//           style: TextStyle(
...
//               color: isSelected
//                   ? Colors.white
//                   : (disabled ? Colors.grey : Colors.black54)),
//         ),
//       ),
//     );
//   }
//
//   Widget _buildFractionToggle(double stdText) {
//     return SwitchListTile.adaptive(
//       contentPadding: EdgeInsets.zero,
//       title: Text("Hourly Fraction",
//           style: GoogleFonts.inter(
//               fontSize: stdText, fontWeight: FontWeight.w600)),
//       subtitle: const Text("Apply leave in hours/minutes",
...
//             fromTimeController.clear();
//             toTimeController.clear();
//             if (fromDateController.text.isNotEmpty) _calculateDays();
//           }
//         });
//       },
//     );
...
//
//   Widget _buildInput(
//       TextEditingController ctrl, String label, IconData icon, double fontSize,
//       {bool isPhone = false}) {
//     return TextField(
//       controller: ctrl,
...
//   }
//
//   Widget _buildTimeInput(String label, TextEditingController ctrl,
//       VoidCallback onTap, double fontSize) {
//     return TextField(
//       controller: ctrl,
//       readOnly: true,
//       onTap: onTap,
...
//       ),
//       child: ElevatedButton(
//         onPressed: isLoading ? null : () => _validation(),
//         style: ElevatedButton.styleFrom(
...
//             : Text(
//                 widget.flag == 2 ? 'UPDATE DETAILS' : 'SUBMIT REQUEST',
//                 style: GoogleFonts.inter(
//                     fontSize: 16,
//                     fontWeight: FontWeight.w800,
//                     color: Colors.white,
...
//           children: [
//             _buildRadioOption(
//                 "1st Half", true, groupVal, onChanged, disabled, fontSize),
//             const SizedBox(width: 12),
//             _buildRadioOption(
//                 "2nd Half", false, groupVal, onChanged, disabled, fontSize),
//           ],
//         ),
//       ],
//     );
//   }
//
//   Widget _buildRadioOption(String text, bool value, bool groupValue,
//       Function(bool?) onChanged, bool disabled, double fontSize) {
//     return InkWell(
