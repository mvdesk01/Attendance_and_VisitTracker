...
class _AlarmScreenState extends State<AlarmScreen> with WidgetsBindingObserver {
  ...
  ReminderSettings? _getSettingsFromPrefs(SharedPreferences prefs, String type, int defaultId) {
  ...
  Future<void> _saveReminderSettings(String type, ReminderSettings settings) async {
    final prefs = await SharedPreferences.getInstance();
