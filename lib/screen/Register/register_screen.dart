...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _registerUser() async {
    ...
    try {
      ...
      var body = jsonEncode({
        "staffCode": _cardIdController.text.trim(),
        ...
        "latitude": "0.0",
        "longitude": "0.0",
        "currAddress": "M-Tech Innovations, Hinjewadi, Pune",
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (_) => BlocProvider(create: (_) => MainBloc(webService: WebService()), child: const LoginScreen())),
        );
      } else {
