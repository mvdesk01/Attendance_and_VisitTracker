...
VisitDataResponse VisitDataResponseFromJson(String str) => VisitDataResponse.fromJson(json.decode(str));

String VisitDataResponseToJson(VisitDataResponse data) => json.encode(data.toJson());


class VisitDataResponse {
  Message? message;

  VisitDataResponse({this.message});

  VisitDataResponse.fromJson(Map<String, dynamic> json) {
    message =
...
class Message {
  ...
  Message({this.totalCount, this.pageNumber, this.pageSize, this.data});
