class Constant {
  ...
  // static String baseUrl = 'https://attendanceappapi.m-techinnovations.com/';
  // static String baseUrl = 'http://192.168.1.19:8015/';       // local server
  static String baseUrl = 'http://114.143.140.28:8020/';       // live server

  static String loginUrl = baseUrl + 'Users/GetLoginData?';
  static String staffDetailsUrl = baseUrl + 'api/GatePass/GetStaffDetails/';
  static String getPendinggatePassUrl = baseUrl + 'api/GatePass/GetPendingGatePass?StaffCode=';
  ...
  static String getleavestaffdetailsUrl = baseUrl+'api/Leave/GetStaffDataForLeave/';
  ...
  static String approvesanction = baseUrl+'api/SanctionAll/SanctionAllScreen/';

  static String submitapprovesanction = baseUrl+'api/SanctionAll/SubmitSanctionOrRejectData';
  ...
  static String GetStaffDetailsForCoff = baseUrl+'api/Coff/GetStaffDetailsForCoff';

  static String SubmitCoff = baseUrl+'api/Coff/SubmitCoff';
  static String FetchCoffTransactions = baseUrl+'api/Coff/FetchCoffTransactions';
  static String CancelCoffOTHWOFF = baseUrl+'api/Coff/CancelCoffOTHWOFF';

  static String GetCoffsTransactions = baseUrl+'api/CoffDebit/GetCoffsTransactions';
  ...
  static String InsertMMALLData = baseUrl+'api/MinutesOfMeeting/InsertMMAllData';
  static String UpdateMeetingFormNo = baseUrl+'api/MinutesOfMeeting/UpdateMeetingFormNo/';
  static String GetMinutesOfMeetingFormNo = baseUrl+'api/MinutesOfMeeting/GetMinutesOfMeetingFormNo/';
  static String GetMinutesOfTheMeetingAllDataByVisitSrNo = baseUrl+'api/MinutesOfMeeting/MinutesOfTheMeetingAllDataByVisitSrNo/';

  static String UpdateMMAllData = baseUrl+'api/MinutesOfMeeting/UpdateMMAllData';
  static String UpdateMMData = baseUrl+'api/MinutesOfMeeting/UpdateMMData';

  static String GetMinutesOfTheMeetingDataByVisitSrNo = baseUrl+'api/MinutesOfMeeting/MinutesOfTheMeetingDataByVisitSrNo/';

  static String fetchcancellationURl = baseUrl+'api/CancellationRequest/FetchRecords';
  static String submitOTcancellation = baseUrl +'api/CancellationRequest/SaveDataOT';
  static String submitleavecancellationUrl = baseUrl+'api/CancellationRequest/SaveDataLeave';
  static String submitgatepasscancellationUrl = baseUrl+'api/CancellationRequest/SaveDataGatePass';
  static String submitcoffcancellationUrl = baseUrl+'api/CancellationRequest/SaveDataCOffCredit';
  static String submitcdebitcancellationUrl = baseUrl+'api/CancellationRequest/SaveDataCOffDebit';
  static String submittourcancellationUrl = baseUrl+'api/CancellationRequest/SaveDataTour';
  static String expensesubmit = baseUrl + 'api/Expense/InsertExpense';

  static String getstafftourdetails = baseUrl +'api/Tour/GetStaffDetailsForTour?StaffCode=';
  static String submittourdetails = baseUrl +'api/Tour/SubmitTour';
  static String getAppliedTour = baseUrl +'api/Tour/TourTransactions?staffcode=';
  static String canceltour = baseUrl+'api/Tour/CancelTour?';
  static String viewexpensedetails = baseUrl+'api/Expense/GetExpenseData?staffcode=';
  static String remotelocationrequest = baseUrl+'Users/UpdateRemoteLocationValues';
