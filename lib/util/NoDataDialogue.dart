...
class NoDataDialogForUpdate{

  poppUp(BuildContext context,String title,String id){
    showDialog(
        context: context,
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Lottie.network(
                        'https://lottie.host/c0c5dfa1-874a-49b7-9079-28e2931dfd65/5pJ6x674Ph.json',width: 1,height: 1),
                    Padding(
